import 'notifier/lt_change_name_one_notifier.dart';
...
class LtChangeNameOneScreen extends ConsumerStatefulWidget {
  const LtChangeNameOneScreen({Key? key}) : super(key: key);

  @override
  LtChangeNameOneScreenState createState() => LtChangeNameOneScreenState();
}

class LtChangeNameOneScreenState extends ConsumerState<LtChangeNameOneScreen> {
  @override
